...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	// criamos as referências para os 4 componentes(botão, tableview, tableviewid e
	// tableviewname)
	...
	private void initializeNodes() {
		// comandos para iniciar apropriadamente o comportamento das colunas da minha
		// tabela
	...
	public void updateTableView() { // esse método vai ser responsável por acessar o serviço, carregar os
									// departamentos,
	...
	private void removeEntity(Department obj) {
		Optional<ButtonType> result = Alerts.showConfirmation("Confirmation", "Tem certeza que você quer deleter ? ");
